export declare namespace MapKit {
    ...
    class Map {
         ...
         * function.
         */
        addEventListener<T, K extends keyof MapEvents<this>>(type: K, listener: (this: T, event: MapEvents<this>[K]) => void, thisObject?: T): void;
        /**
         * Removes an event listener.
         */
        removeEventListener<T, K extends keyof MapEvents<this>>(type: K, listener: (type: T, event: MapEvents<this>[K]) => void, thisObject?: T): void;
        /**
    ...
    interface MapUserLocationEvents<T> {
        ...
        "user-location-error": EventBase<T> & {
            code: number;
            message: string;
        };
    }
    ...
    type MapEvents<T> = MapDisplayEvents<T> & MapAnnotationOverlayEvents<T> & MapUserLocationEvents<T> & MapInteractionEvents<T>;
    /**
    ...
    class Annotation {
         ...
         */
        constructor(coordinate: Coordinate, factory: (coordinate: Coordinate, options: AnnotationConstructorOptions) => Element, options?: AnnotationConstructorOptions);
        /**
         * Adds an event listener to handle events triggered by user interactions
         * with annotations.
         *
         ...
         * listener function.
         */
        addEventListener<T>(type: AnnotationEventType, listener: (this: T, event: EventBase<Map>) => void, thisObject?: T): void;
        /**
         * Adds an event listener to handle events triggered by user interactions
         * with annotations.
         *
         ...
         * function.
         */
        removeEventListener<T>(type: AnnotationEventType, listener: (this: T, event: EventBase<Map>) => void, thisObject?: T): void;
        /**
    ...
    interface AnnotationCalloutDelegate {
         ...
         */
        calloutAnchorOffsetForAnnotation?(annotation: Annotation, size: {
            width: number;
            height: number;
        }): DOMPoint;
        /**
    ...
    class Geocoder {
         ...
         * reverse geocoder.
         */
        reverseLookup(coordinate: Coordinate, callback: (error: Error | null, data: GeocoderResponse) => void, options?: Pick<GeocoderConstructorOptions, "language">): number;
        /**
    ...
    class Search {
         ...
         */
        autocomplete(query: string, callback: SearchDelegate | AutocompleteSearchCallback, options?: SearchAutocompleteOptions): void;
        /**
    ...
    class PointsOfInterestSearch {
         ...
         * pending request.
         */
        search(callback: PointsOfInterestSearchDelegate | PointsOfInterestSearchCallback, options?: PointsOfInterestSearchOptions): number;
        /**
         * Cancels a search request using its request ID.
         *
         * @param id The integer ID returned by a call to Search.search
     ...
     */
    function importGeoJSON(data: string | object, callback?: GeoJSONDelegate | ImportGeoJSONCallback): ItemCollection | Error;
